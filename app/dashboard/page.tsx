...
export default function DashboardPage() {
  ...
  const TOOLS = [
    { href: "/itinerary",      icon: Sparkles, label: "Plan a Trip",      desc: "Personalised multi-day itineraries crafted by AI",     color: "#C84B31" },
    { href: "/explore",        icon: Brain,    label: "AI Guide",         desc: "Chat with an expert AI trained on Tunisia and Maghreb",         color: "#E8C98A" },
    { href: "/heritage",       icon: Camera,   label: "Heritage",        desc: "Point your camera to unlock history",      color: "#1A7A6E" },
    { href: "/sustainability",  icon: Leaf,    label: "Eco Dashboard",   desc: "Live crowd forecasts and eco-scores", color: "#4ADE80" },
  ];
    ...
    <div className="min-h-screen bg-[#0F1419]" >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          ...
          <p className="text-stone-mist ml-14">{"Plan your first journey!"}</p>
        </motion.div>
