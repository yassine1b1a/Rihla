...
const WELCOME_MESSAGE = `# مرحباً — Marhaba! Welcome to Rihla AI 🧭
...
export default function ExplorePage() {
  const [msgs, setMsgs] = useState<Msg[]>([{ id: "0", role: "assistant", content: WELCOME_MESSAGE }]);
  ...
  return (
    <div className="flex h-screen bg-[#0F1419] overflow-hidden flex-col">
      ...
      <div className="flex flex-1 overflow-hidden pt-16">
        {/* Sidebar */}
        <aside
          className="hidden lg:flex flex-col w-72 border-r flex-shrink-0 overflow-y-auto"
        ...
        >
          ...
          <div className="p-4 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
            ...
            <div className="space-y-1">
              {STARTERS.map(s => (
                ...
                >
                  <ChevronRight className="w-3 h-3 flex-shrink-0 mt-0.5 text-terra-dark" />
                  {s}
                </button>
              ))}
            </div>
          ...
          <div className="p-4">
            ...
            {DEST_QUICK.map(d => (
              <button
                key={d.id}
                onClick={() => send(`Tell me about ${d.name} in ${d.country}`)}
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          >
            ...
            <button
              onClick={() => setMsgs([{ id: "0", role: "assistant", content: WELCOME_MESSAGE }])}
                  ...
                  <div
                    ...
                    style={{
                      background: msg.role === "assistant"
                        ? "linear-gradient(135deg, #C84B31, #E8C98A)"
                  ...
                  <div
                    ...
                    style={{
                      background: msg.role === "user"
                        ? "linear-gradient(135deg, rgba(200,75,49,0.2), rgba(232,201,138,0.12))"
                        : "rgba(28,35,48,0.7)",
          ...
          >
            ...
            <div className="flex gap-3 items-end max-w-3xl mx-auto">
              <div
                ...
                style={{ background: "rgba(28,35,48,0.8)", border: "1px solid rgba(255,255,255,0.08)" }}
              >
                <textarea
                  value={input}
