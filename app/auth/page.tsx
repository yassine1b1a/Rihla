...
function AuthForm() {
  ...
  return (
    <div className="min-h-screen bg-[#0F1419] flex items-center justify-center px-4 relative overflow-hidden" dir={dir}>
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
        ...
        <div className="p-8 rounded-2xl" style={{ background: "rgba(28,35,48,0.9)", border: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-stone-mist font-mono">{t('auth.or')}</span>
            <div className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.06)" }} />
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            {mode === "signup" && (
              <div>
                <label className="text-xs font-mono text-stone-mist uppercase tracking-widest mb-2 block">{t('auth.name')}</label>
            ...
            <div>
              <label className="text-xs font-mono text-stone-mist uppercase tracking-widest mb-2 block">{t('auth.email')}</label>
              <div className="relative">
            ...
            <div>
              <label className="text-xs font-mono text-stone-mist uppercase tracking-widest mb-2 block">{t('auth.password')}</label>
              <div className="relative">
